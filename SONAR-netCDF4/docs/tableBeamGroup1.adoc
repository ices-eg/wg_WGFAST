...
e|Variables | |
 ...
 |{var}float rx_beam_rotation_alpha(ping_time, beam) |M |The intrinsic _z_–_y_’–_x_” clockwise rotation about the _z_-axis of the platform coordinate system needed to give the receive beams coordinate system.

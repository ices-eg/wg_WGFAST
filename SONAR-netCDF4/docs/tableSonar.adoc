...
e|Types | |
 ...
 2+|{var}byte enum beam_t {single = 0, split_aperture_angles = 1, split_aperture_4_sector = 2, split_aperture_3_sector = 3, split_aperture_3_1_sector = 4} |Beam type. Split aperture indicates a beam that can detect the arrival angle of echoes, while single beam cannot.

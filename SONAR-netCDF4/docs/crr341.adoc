...
.The split-aperture transducer arrangements supported by SONAR-netCDF4. The axis indicates the orientation of the sonar beam coordinate system (note that the _z_-axis goes into the page).
[[transducer_types]]
image::splitAperatureTransducers.svg[]

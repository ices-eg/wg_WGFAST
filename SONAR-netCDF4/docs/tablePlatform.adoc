...
|:units = "m" | |
| | |
|int transducer(transducer) |R |transducer serial number
| | |
...
| | |
|transducer_type_t transducer_type(transducer) |M |The type of transducer, might be rx , tx or monostatic
|:long_name = " type of transducer" | |
| | |

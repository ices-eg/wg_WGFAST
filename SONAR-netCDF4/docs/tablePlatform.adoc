...
|float :valid_range = −180.0, 180.0 | |
| | |
|string MRU_ids(MRU) |R |MRU serial number or identification name
| | |
...
|:units = "m" | |
|Subgroups | |
|Position |M |Suggested subgroup to store Position sensor data.
|Attitude |M |Suggested subgroup to store MRU sensor data.
|==============================================================================================================================================================================================================

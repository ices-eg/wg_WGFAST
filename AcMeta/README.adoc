...
The current working draft of the metadata convention is in the `SISP_formatted` folder as an HTML file. To view the file in your web browser, please go The current working draft of the metadata convention is in the `SISP_formatted` folder as an HTML file. To view the file in your web browser, please go (https://htmlpreview.github.io/?https://github.com/ices-eg/wg_WGFAST/blob/master/Formatted_docs/TG-AcMeta.html)[here].

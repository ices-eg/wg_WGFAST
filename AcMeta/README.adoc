...
This directory contains the text and source files necessary to generate the https://github.com/ices-eg/wg_WGFAST/blob/master/AcMeta/acmeta.adoc[AcMeta convention document]. It is also the place where new versions of the convention are discussed and developed.
...
The current working draft of the metadata convention is in the `SISP_formatted` folder as an HTML file. To view the file in your web browser, please go https://htmlpreview.github.io/?https://github.com/ices-gists/wg_WGFAST/blob/master/SISP_formatted/TG-AcMeta.html[here].

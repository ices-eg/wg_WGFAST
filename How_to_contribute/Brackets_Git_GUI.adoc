...
3. You can name your new remote anything you would like, but it is a good idea to call it `upstream` to stay with Git parlance. +
...
To open the AsciiDoc live preview pane, click on the AsciiDoc extension in the right side of the screen. The extension icon will only be present if an AsciiDoc document is open. +
{empty} +
